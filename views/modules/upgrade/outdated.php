<div class="update-notification" id="update">
    ...
    <div class="cf">
	<a class="blue-btn update" href="<?php echo site_url('admin/upgrade/update_if_no_conflicts');?>"><span><?php echo __('settings:updatenow');?></span></a>
	<a class="blue-btn hide"><span><?php echo __('global:dontshowagain');?></span></a>
    </div>
    <?php else: ?>
