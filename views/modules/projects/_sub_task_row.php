<div class="row <?php echo ((bool) $task['completed']) ? 'completed' : 'incomplete'; ?>">
		...
		<div class="twelve columns">
            ...
            <div class="timer large-timer" <?php timer($timers, $task['id']);?>>
                <div class="four columns track-time " data-task-id="<?php echo $task['id'];?>" data-project-id="<?php echo $project->id ?>" data-time-start="<?php echo isset($task['entry_started']) && $task['entry_started'] ? strtotime(date('Y-m-d', $task['entry_started_date']).' '.$task['entry_started_time']).'000' : '' ?>">

                    <span class="time-ticker timer-time">00:00:00</span>
                    <span class="task-buttons">
                        <a class="task-btn play timer-button <?php echo isset($task['entry_started']) && $task['entry_started'] ? 'running' : '' ?>" href="#" data-start="<?php echo __('global:start') ?>" data-stop="<?php echo __('global:stop') ?>" >P</a>
		    ...
		    <div class="row task-details">
                ...
                <?php echo anchor('admin/projects/times/view_entries/task/'.$task['id'], __('tasks:view_entries'), array('class' => 'task-icon time', 'title' => __('tasks:view_entries'))) ?>
